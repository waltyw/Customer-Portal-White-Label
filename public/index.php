...
$routes = [
    ...
    'POST /account/notification-emails'   => [AccountController::class,  'saveNotificationEmails'],
    ...
    'GET /admin/tickets/create'   => [AdminController::class,    'createTicket'],
    'POST /admin/tickets/create'  => [AdminController::class,    'storeTicket'],
