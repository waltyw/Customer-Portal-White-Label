...
<head>
    ...
    $logoLink   = \App\Models\Setting::get('logo_link_url') ?: '/dashboard';
...
<aside class="drawer" id="drawer">
    ...
    <nav class="drawer-nav">
        ...
        <a href="<?= \App\Core\Security::e($link['url']) ?>" class="nav-item" <?= !empty($link['new_tab']) ? 'target="_blank" rel="noopener"' : '' ?>>
    ...
    <div class="drawer-footer">
        <div class="drawer-user-info">
            <div class="drawer-avatar"><?= strtoupper(substr($user['name'] ?? 'U', 0, 1)) ?></div>
            <div>
                <div class="drawer-user-name"><?= \App\Core\Security::e($user['name'] ?? '') ?></div>
                <div class="drawer-user-sub"><?= \App\Core\Security::e($user['company'] ?? '') ?></div>
            </div>
        </div>
